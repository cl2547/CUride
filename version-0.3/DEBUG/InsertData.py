...
keys = np.array(['Name','Phone','Wechat','Email','Date','Time',
	'FromCity','ToCity','NoOfPpl','Price','Type','SubmitTime','TextArea'])
...
curide_url = "http://localhost:8081/myfiles/curide/src/curide-0.3/index.php?username=asdf"
